...
# details, MBOX is a text file, which stores emails consecutively. 
...
# and does not act as a separator. Imagine you wrote a minimalist email app, 
# that lists the email of the senders in the user’s Inbox and counts the number of 
# emails.
